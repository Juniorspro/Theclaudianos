...
window.__L = {J, JUG, CTRL, CAMARA, UI, PROG, AJ, POST, PISO, CAPITULOS, ARMAS, TR_FALTA, _AUD, get ENEM(){ return ENEM; }, get ITEMS(){ return ITEMS; }, get CUERPOS(){ return CUERPOS; }, get BALAS(){ return BALAS; },
  empezarCap, jugarCap, cargarPiso, terminarCapitulo, reintentar, volverAlMenu, ponerIdioma, matar, hacerAccion, accionDisponible, tirarArma, seVe, campo, pasoCampo, chocaCirculo, irA, centroPalo, centroAccion, centroGolpe, aMundo, textoLibre:() => [..._AUD], SON, sim:(n, dt) => { for(let i = 0; i < n; i++) paso(dt); }, get ESTADOS(){ return ESTADOS_PISO; }};
