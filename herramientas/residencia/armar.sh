...
{ cat /tmp/res_cab.html; echo "(function(){"; cat 1_base.js 9_idiomas.js $AUDIO 3_texturas.js 4_casa.js 4b_muebles.js 5_render.js 6_jugador.js 7_mundo.js 8_monstruo.js 8b_ia.js 8c_partida.js 9a_ui.js 9b_menu.js 9z_arranque.js z.js; } > "$R/juegos-pc/Residencia.html"
mkdir -p /tmp/ui/res
