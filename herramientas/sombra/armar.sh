...
{ cat /tmp/sombra_cab.html; echo "(function(){"; echo "'use strict';"; cat 9_idiomas.js 1_base.js $AUDIO 3_arte.js 4_post.js 5_mundo.js 6_juego.js 6b_jefes.js 8_ui.js 8d_menu.js 9z_arranque.js z.js; } > "$R/juegos-pc/Sombra.html"
