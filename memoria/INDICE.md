...
|---|---|---|
| `juegos-pc/` | los HTML: `Cabezones.html`, `Chicharra.html` (de acá) y `Bosque.html` (otra línea) | [repo](repo.md) |
...
| `herramientas/cabezones/` | horneado de arte, música y efectos | [cabezones](cabezones.md) |
| `pruebas/cabezones/`, `pruebas/chicharra/` | los bancos de cada juego | la nota del juego |
